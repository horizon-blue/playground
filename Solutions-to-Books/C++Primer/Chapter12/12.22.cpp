// Exercise 12.22
// What changes would need to be made to StrBlobPtr to create a class that can be used
// with a const StrBlob? Define a class named ConstStrBlobPtr that can point to a const StrBlob.
// Xiaoyan Wang 8/4/2016
// mostly copied from 12.19.cpp
#ifndef EX_12_22_CPP
#define EX_12_22_CPP // I usd .cpp instead of .h just for consistency of the names
#include <string>
#include <vector>
#include <memory>
